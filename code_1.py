...
st.set_page_config(page_title="Predicting crop production based on Agricultural Data", layout="wide")
...
df = pd.read_excel(r"C:\Users\HP\OneDrive - presidencyuniversity.in\Desktop\Guvi project 3\FAOSTAT_data.xlsx")
